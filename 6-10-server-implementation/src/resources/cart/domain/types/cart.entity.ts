import {
  ProductEntity,
  product as bookProduct,
} from "../../../../resources/product/domain/types/product.entity";
...
// Stored
export interface CartEntityStoredBase
  extends CartEntityBase<CartItemEntityStored> {
  isDeleted: boolean;
}
